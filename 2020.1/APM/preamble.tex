...
\newcounter{currslidenum}
\newcommand{\newslide}[2][]{
    \ifthenelse{\equal{\isfirstslide}{1}}{}{\clearpage}
    \def\isfirstslide{0}
    \setcounter{currslidenum}{#2}
    \section*{\ifthenelse{\equal{#1}{}}{Slide #2}{#1}}
    \hrule
    \insertslide{#2}
}
\newcommand{\nextslide}[1][]{
    \stepcounter{currslidenum}
    \ifthenelse{\equal{#1}{}}{%
    \newslide{\thecurrslidenum}}{%
    \newslide[#1]{\thecurrslidenum}}
}
\newcommand{\insertminislides}[2][0]{
	...
	\ifnum#1>0 %
		...
		%\stepcounter{minislidescounter}
		%\ifnum \minislidescounter<\looplimit
		\advance \minislides by 1
...
\newkeycommand*\nextslides[title,slide,until,highlight]{
	...
	\stepcounter{currslidenum}
	\startslide=\thecurrslidenum
    }{
	\startslide=\commandkey{slide}
	\ifthenelse{\equal{\commandkey{until}}{}}{
	    \setcounter{currslidenum}{\the\startslide}
	}{
	    \setcounter{currslidenum}{\commandkey{until}}
	}
    }
...
\newcommand{\lecture}[4][]{
	...
	\def\isfirstslide{1}
	\setcounter{currslidenum}{0}
    }
    \ifthenelse{\isempty{#4}}{%
        \def\@lecture{Lecture #2}%
    }{%
        \def\@lecture{Lecture #2: #4}%
    }%
    \subsection*{\@lecture}
